        ...
        <div className="row">
          <div className="col-4">
            <div className="price">
              ...
              <p className="price_rs">Rs100.00</p>
            </div>
          </div>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <p className="price_rs">Rs250.00</p>
            </div>
          </div>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <p className="price_rs">Rs150.00</p>
            </div>
          </div>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <p className="price_rs">Rs220.00</p>
            </div>
          </div>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <p className="price_rs">Rs300.00</p>
            </div>
          </div>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <p className="price_rs">Rs500.00</p>
            </div>
          </div>
        </div>
      </div>
